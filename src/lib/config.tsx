    ...
    items: [
      {
        ...
        content: "Built from the ground up for cloud environments",
      },
      {
        id: 2,
        ...
        content: "AI-powered optimization of cloud resources",
      },
      {
        id: 3,
        ...
        content: "Military-grade security and compliance features",
      },
    ],
  },
  growthSection: {
